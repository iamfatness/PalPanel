...
Write-Host "     ServerExePath, SaveDirectory, BackupDirectory, AccessTeamDomain, and AccessAud values"
Write-Host "     (see docs/setup-cloudflare.md). Never commit this file."
